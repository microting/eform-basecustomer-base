...
def main():
    ...
    if int(get_git_status()) > 0:
        ...
        os.chdir("Microting.eFormBaseCustomerBase")
        ...
        process_repository('Microting.eFormBaseCustomerBase.csproj', packages, 'eform-basecustomer-base')
        ...
        if new_number_of_commits > current_number_of_commits:
            ...
            os.chdir("..")
            run_command(f"github_changelog_generator -u microting -p eform-basecustomer-base -t {os.getenv('CHANGELOG_GITHUB_TOKEN')}", shell=True)
