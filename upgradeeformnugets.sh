...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormBaseCustomerBase/Microting.eFormBaseCustomerBase.csproj package Microting.eForm
	dotnet add Microting.eFormBaseCustomerBase/Microting.eFormBaseCustomerBase.csproj package Microting.eFormApi.BasePn
